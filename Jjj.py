...
headers = {
    ...
    'lan': 'en',
    'origin': 'https://mig.jackdawflip.io',
    'pragma': 'no-cache',
    'priority': 'u=1, i',
    'referer': 'https://mig.jackdawflip.io',
...
def bbq_tap():
    ...
    response = requests.post('https://mig.jackdawflip.io/api/coin/earnmoney', headers=headers, data=data)
